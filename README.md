# 🛡️ KeepeR - Proyecto Completo (Frontend & Backend)

Este es el repositorio central de KeepeR, que contiene tanto la Aplicación de una Sola Página (Frontend) como la API REST (Backend).

---

## 🎨 PARTE 1: FRONTEND (Interfaz de Usuario)
...
## ⚙️ PARTE 2: BACKEND (API y Lógica de Negocio)
