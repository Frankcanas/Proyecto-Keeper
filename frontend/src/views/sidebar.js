    ...
    <aside id="sidebar-aside" class="fixed inset-y-0 left-0 w-72 bg-[#09090b] text-zinc-150 flex flex-col justify-between border-r border-zinc-850 z-50 transform -translate-x-full transition-transform duration-300 lg:translate-x-0 lg:static lg:flex shrink-0 select-none font-sans px-6 py-8">
      ...
      <div>
        ...
        <nav class="mt-6 space-y-1">
          ...
          <button id="homepage-btn-reportes" class="homepage-nav-btn flex w-full items-center gap-3 rounded-md px-3 py-2 text-left text-xs font-medium text-zinc-400 hover:text-white hover:bg-zinc-900/50">
            <svg class="h-4 w-4 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
      ...
      <div>
        ...
        <nav class="mt-6 space-y-1">
          <button id="sidebar-btn-usuarios" class="sidebar-nav-btn flex w-full items-center gap-3 rounded-md px-3 py-2 text-left text-xs font-medium text-zinc-400 hover:text-white hover:bg-zinc-900/50">
            <svg class="h-4 w-4 text-zinc-550" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
